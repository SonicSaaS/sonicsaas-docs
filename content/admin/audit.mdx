---
title: Audit Log
description: Immutable, append-only record of every significant platform action — who, what, when, result, and before/after values — for SOC 2 evidence and forensics.
keywords: [audit log, SOC 2, compliance, immutable, forensics, append-only, retention, controls, Splunk]
---
