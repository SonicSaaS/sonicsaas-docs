---
title: Database
description: View schema, migration status, and basic health for the PostgreSQL database that backs your self-hosted SonicSaaS instance.
keywords: [database, schema, migrations, PostgreSQL, self-hosted, admin, health]
---
