---
title: Operations
description: Track every fleet operation — firmware updates, backups, restores, reboots — with per-device status, concurrency control, and full audit detail.
keywords: [operations, jobs, fleet, progress, status, concurrency, cancellation, SOC 2, audit]
---
