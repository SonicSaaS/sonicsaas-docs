...
description: Dashboard that continuously evaluates each firewall against active policies and surfaces compliant, non-compliant, and unknown devices for remediation.
keywords: [compliance, checking, policy, dashboard, non-compliant, remediation, fleet, SonicWall]
---
