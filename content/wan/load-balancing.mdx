...
description: Compare WAN load-balancing policies across the fleet — round-robin, spillover, ratio — and verify failover and traffic distribution behavior.
keywords: [load balancing, WAN, dual-WAN, round-robin, spillover, ratio, failover, SonicWall, ISP]
---
