...
description: Define minimum and target firmware versions per SonicWall model so the audit can flag devices that need urgent patching or planned upgrades.
keywords: [firmware targets, minimum version, target version, upgrade, patch, model, SonicWall, MySonicWall]
---
