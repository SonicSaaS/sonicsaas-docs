---
title: Fleet Restore
description: Push a previous configuration back to one or many SonicWalls for rollback, disaster recovery, or replacement-hardware cloning, with safety pre-backup.
keywords: [restore, rollback, disaster recovery, configuration, SonicWall, replacement, cloning, drift remediation]
---
