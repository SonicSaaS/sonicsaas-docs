---
title: Fleet Backup
description: Run on-demand or scheduled configuration backups across every SonicWall, with AES-256-GCM encryption and optional offsite FTP redundancy.
keywords: [backup, fleet backup, configuration, SonicWall, encrypted, FTP, AES-256-GCM, schedule, coverage]
---
