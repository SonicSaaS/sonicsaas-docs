...
description: Connect a SonicWall firewall to SonicSaaS by entering its management IP, port, and admin credentials, or bulk-import a fleet from CSV.
keywords: [add device, onboard firewall, SonicWall, CSV import, bulk import, credentials, management API, AES-256-GCM]
---
