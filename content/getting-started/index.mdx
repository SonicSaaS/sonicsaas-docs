...
description: Onboarding walkthrough for new SonicSaaS teams — add your first firewall, run a backup, set firmware targets, and connect integrations.
keywords: [getting started, onboarding, setup, first device, SonicWall, MSP, fleet, quickstart]
---
