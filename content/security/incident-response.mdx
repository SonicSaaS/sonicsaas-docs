...
description: Documented severity classification, detection, containment, recovery, and post-incident review procedures for credential compromise and data breach scenarios.
keywords: [incident response, IR, severity, P1, containment, breach, credential rotation, evidence preservation, tabletop]
---
