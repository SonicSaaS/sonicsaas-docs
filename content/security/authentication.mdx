...
description: How SonicSaaS handles sign-in — database sessions, secure cookies, TOTP MFA, recovery codes, Entra SSO, bcrypt passwords, lockout, and rate limiting.
keywords: [authentication, MFA, TOTP, sessions, cookies, bcrypt, SSO, Entra ID, password reset, rate limit]
---
