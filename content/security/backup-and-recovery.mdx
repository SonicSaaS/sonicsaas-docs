...
description: Documented disaster-recovery plan with RTO/RPO/MTTR targets covering database, encryption keys, and config backup files for the self-hosted stack.
keywords: [backup, recovery, disaster recovery, DR, RTO, RPO, MTTR, database, encryption keys, restore]
---
