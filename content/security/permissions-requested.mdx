...
description: Reference list of every third-party permission and credential SonicSaaS may request — Entra, MySonicWall, ConnectWise, ITGlue, Huntress, Splunk, SMTP — and what breaks without each.
keywords: [permissions, scopes, Microsoft Graph, least privilege, OAuth, API key, Entra ID, ConnectWise, ITGlue, MySonicWall]
---
