...
description: Layered security architecture — auth, RBAC, encryption, input validation, audit, and infrastructure controls — designed around SOC 2 Type II requirements.
keywords: [security, SOC 2, RBAC, encryption, AES-256-GCM, MFA, audit, hardening, self-hosted]
---
