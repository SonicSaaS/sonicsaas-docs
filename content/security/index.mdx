...
- **You control the data** — PostgreSQL runs on your infrastructure with no external telemetry or data sharing
...
- [Infrastructure Security](/security/infrastructure) — Docker hardening, network isolation, security headers
