---
title: Encryption
description: How SonicSaaS protects credentials, MFA secrets, and backups with AES-256-GCM, separate keys per data class, and minimum-exposure decryption flows.
keywords: [encryption, AES-256-GCM, bcrypt, key management, credentials, MFA secret, backups, at rest]
---
