...
description: Five built-in roles (owner, admin, operator, viewer, auditor) with action:resource permissions, organization restrictions, and team-scoped data isolation.
keywords: [roles, permissions, RBAC, owner, admin, operator, viewer, auditor, organization restriction, team isolation]
---
