...
description: Current SOC 2 Type II control implementation status (45 of 52 controls) plus mappings to OWASP, NIST CSF, ISO 27001, CIS Controls, and PCI DSS.
keywords: [compliance, SOC 2, Type II, OWASP, NIST CSF, ISO 27001, CIS Controls, PCI DSS, controls, audit]
---
