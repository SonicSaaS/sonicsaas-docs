---
title: Schedules
description: Configure recurring jobs — Device Metrics, Device Config (smart-poll), WAN Probe, ITGlue sync, credential rotation, and SOC 2 evidence snapshots.
keywords: [schedules, polling, Device Metrics, Device Config, smart poll, WAN probe, sync, cron, evidence snapshot]
---
