...
description: Change your password and manage TOTP multi-factor authentication, including recovery codes and session revocation on credential changes.
keywords: [account security, password, MFA, TOTP, authenticator, recovery codes, HIBP, session revocation]
---
