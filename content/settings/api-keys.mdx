---
title: API Keys
description: Create scoped API keys for automation and scripting with SHA-256 hashed storage, IP allowlists, expirations, last-used tracking, and full audit.
keywords: [API keys, REST API, automation, scope, IP allowlist, expiration, rate limiting, programmatic]
---
