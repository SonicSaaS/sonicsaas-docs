---
title: User Sync
description: Scheduled job that pulls local accounts, group memberships, and MFA status from every firewall so compliance evaluation has fresh data.
keywords: [user sync, schedule, MFA, groups, local accounts, polling, SonicWall]
---
