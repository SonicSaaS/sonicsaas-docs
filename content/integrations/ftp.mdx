---
title: FTP Server
description: Push encrypted configuration backups to an external FTP server and stage firmware images for SonicWall Gen 6 appliances to retrieve.
keywords: [FTP, backup storage, firmware staging, Gen 6, SonicWall, offsite, AES-256-GCM]
---
