---
title: Splunk
description: Forward SonicSaaS audit, device, policy, and alert events to Splunk via the HTTP Event Collector for SIEM correlation and tamper-evident retention.
keywords: [Splunk, SIEM, HEC, HTTP Event Collector, log forwarding, audit, JSON, compliance]
---
