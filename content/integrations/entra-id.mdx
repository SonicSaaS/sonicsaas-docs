...
description: Enable Microsoft 365 SSO with auto-provisioning and security-group-to-role mapping using a single multi-tenant Azure app registration.
keywords: [Entra ID, Azure AD, SSO, single sign-on, OAuth, group mapping, multi-tenant, Conditional Access, MFA]
---
...
For the full list of Microsoft Graph permissions SonicSaaS requests across all features (and what each one is used for), see [Permissions We Request](/security/permissions-requested).
