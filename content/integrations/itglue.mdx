---
title: ITGlue
description: Bidirectional sync of organizations, configurations, and device traits between SonicSaaS and ITGlue, with continuous sync-back after every device poll.
keywords: [ITGlue, documentation platform, flexible assets, passwords, sync-back, organizations, configurations, API key]
---
